...
public class LoanUpdateServicesAspect {
    ...
    public void updateStudentAndBook(CreateLoanDTO createLoanDTO) {
        try {
            ...
            log.info("El estudiante {} ahora tiene {} préstamos y el libro '{}' tiene {} existencias.",
                    student.name(), student.countLoans(), book.title(), book.quantity());
        } catch (Exception e) {
            log.error("Error al actualizar el estudiante o el libro después de crear el préstamo: ", e);
        }
    }
    ...
    public void updateStudentAndBookAfterDeleteLoan(Long id) {
        ...
        try {
            ...
            log.info("Devolucion exista!, el estudiante {} ahora tiene {} prestamos y el libro {} tiene {} existencias.",
                    student.name(), student.countLoans(), book.title(), book.quantity());


        } catch (Exception e) {
            log.info("Ocurrio un error al intentar actualizar al estudiante y el libro");
        }
    }
}
